...
namespace SignalRApi.Hubs
{
    public class SignalRHub : Hub
    {
		...
		public SignalRHub(ICategoryService categoryService, IProductService productService, IOrderService orderService, IMoneyCaseService moneyCaseService, IMenuTableService menuTableService, IBookingService bookingService = null, INotificationService notificationService = null)
		{
        ...
        public async Task SendProgress()
        {
            ...
            await Clients.All.SendAsync("ReceiveTotalMoneyCaseAmount", value.ToString("F2") + "₺");
